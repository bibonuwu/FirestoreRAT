...
{
    /// <summary>
    /// Окно чата Admin ↔ Client через Cloud Firestore.
    /// Firestore:
    ///   pcList/{pcKey} – поля adminOpen/adminOnline/clientOpen/clientOnline
    ///   pcList/{pcKey}/chatMessages – коллекция сообщений.
    /// </summary>
